...
# mobilemoney
./crunch.sh planet.mbtiles generic 32
cp generic.mbtiles $RESULTS_DIR/generic.mbtiles.tmp
rm $RESULTS_DIR/generic.mbtiles -f
mv $RESULTS_DIR/generic.mbtiles.tmp $RESULTS_DIR/generic.mbtiles
